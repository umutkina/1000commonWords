...
public class QuestionsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.kendini_test_et));
        ...
        for (int i = questionCount; i > 0; i--) {
            ...
            String word ;
            do {
                i1 = random.nextInt(allWords.size());

                word = allWords.get(i1);
            }
    ...
    public void setAnswer(String text, final TextView textView) {
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (correctAnswer) {
                    correctCount++;
                    textView.setBackgroundColor(ContextCompat.getColor(QuestionsActivity.this, R.color.green));
                } else {


                    textView.setBackgroundColor(ContextCompat.getColor(QuestionsActivity.this, R.color.red));
...
//        new LongOperation().execute(text);
    ...
    public void answerColor(TextView textView) {
        ...
        if (b) {
            ...
            textView.setBackgroundColor(ContextCompat.getColor(QuestionsActivity.this, R.color.gray));
